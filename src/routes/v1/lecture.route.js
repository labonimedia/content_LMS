...
router
  ...
  .get( lectureVideoController.queryLectureVideos);  //validate(lectureVideoValidation.getLectures),
...
router
  .route('/get/all-lecture/:chapterId')
  .get( lectureVideoController.getLectureVideobychapId); //validate(lectureVideoValidation.getLectureVideobychapterId),
